...
export const Dimensions_Width = width
export const toTranslation = (to: Position) => {
    ...
    const indexes = {
        x: col.charCodeAt(0) - "a".charCodeAt(0), //charCodeAt -> đổi ký tự sang số , ký tự ở vị trí bất kỳ - ký tự a là 97
        y: parseInt(row, 10) - 1,
    };
    return {
        x: indexes.x * SIZE,
...
export const toPosition = ({ x, y }: Vector) => {
    "worklet"; // của thư viện redash , giúp animation mượt hơn
